import { AppBaseRoutes, AppRoutes } from '~/constants/routes-config';
...
export const routeHelpers = {
    ...
    getEditRecipePath: (category: string, subCategory: string, id: string) =>
        `${AppBaseRoutes.EDIT_RECIPE}/${category}/${subCategory}/${id}`,
    getEditDraftPath: (id: string) => `${AppBaseRoutes.EDIT_DRAFT}/${id}`,
